...
Original file is located at
    https://colab.research.google.com/drive/1i21g7K4962VyAUjbrbGprFh8nXYVo5FY
"""
...
model = 0 #import mnli debiased MLM model
biased_model = 0 #import HANS biased final model
...
snli_train_all, snli_y = getTrainSentences(HANS_train)
...
snli_train_y = snli_y
snli_dev_X, snli_dev_y = getTrainSentences(HANS_dev)
...
snli_dev_inputs.keys()

snli_dev_inputs.labels.shape
...
set_seed(42)
debiased_model_HANS, optimizer, scheduler = initialize_model(epochs=2)
train(debiased_model_HANS, biased_model, snli_train_dataloader, snli_dev_dataloader, epochs=2, evaluation=True)

torch.save(debiased_model_HANS, "path")
